        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services
                ...
                .AddRazorPagesOptions(options =>
                {
                    ...
                    options.Conventions.AuthorizeAreaFolder("Adminstrator", "/Discounts/CustomerDiscount", "customerDiscount");
                    options.Conventions.AuthorizeAreaFolder("Adminstrator", "/Discounts/ColleagueDiscount", "colleagueDiscount");
